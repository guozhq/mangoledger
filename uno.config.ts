...
export default defineConfig({
  ...
  shortcuts: {
    'j-btn': 'h-48px w-100% bg-#9ccb3b b-none text-white text-18px rounded-8px px-12px',
    'j-input-text': 'h-48px px-16px leading-32px py-8px b-#9ccb3b b-1 focus:shadow focus:shadow-inset rounded-8px text-18px',
